...
A massive arachnid that lurks in dark places, spinning webs to trap the unwary.

| d6 | Move |
|----|------|
| 1 | **Pounce** — Leaps and pins target (held until spider moves) |
| 2 | **Web** — Shoots sticky web at feet (held until freed) |
| 3 | **Venomous Bite** — 1 damage, ignores armor |
| 4 | **Spawn Swarm** — 2 spider minions join the fight |
...
A towering brute standing 12 feet tall, armed with a massive club or uprooted tree. Stupid but devastatingly strong.
...
A hulking humanoid covered in thick hide and bad attitude. Wears scavenged armor and carries a brutal weapon.
...
| 6 | **Thick Skull** — Ignores next source of damage; shrugs it off with a grunt |
...
A winged horror with a woman's face and a vulture's body. Its haunting song lures victims to their doom.
...
A massive gastropod oozing caustic slime. Slow but relentless, dissolving everything in its path.
...
| 6 | **Toxic Cloud** — Releases noxious fumes; all nearby take -1 to rolls while in the cloud |
...
A small dragon the size of a horse, with scales like cooling embers and smoke curling from its nostrils. Cunning and territorial.
...
| 6 | **Hoarding Instinct** — Fixates on shiniest item visible; will pursue that character relentlessly |
...
A strange fey predator from the deep woods, standing waist-high with an elegant, spotted coat of pink and violet. Its oversized ears track the faintest sound, and its tufted tail sways hypnotically. Glimmerfangs are eerily intelligent, toying with prey before striking.
...
| Terror | Hearts | Armor | Theme |
|--------|--------|-------|-------|
| Giant Spider | 5 | 1 | Webs, poison, ambush |
| Hill Giant | 5 | 1 | Raw strength, thrown objects |
| Ogre | 5 | 2 | Brute force, durability |
| Harpy | 5 | 1 | Flight, charm, sound |
| Giant Slug | 5 | 2 | Acid, slow but deadly |
| Flame Drake | 5 | 1 | Fire, flight, cunning |
| Glimmerfang | 5 | 1 | Fey trickery, speed, sound |
